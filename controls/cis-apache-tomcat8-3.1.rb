...
control 'cis-apache-tomcat8-3.1' do
...
"
  desc 'fix', "Perform the following to set a nondeterministic value for the
...
characters.
"
  desc 'default value', "The default value for the shutdown attribute is
SHUTDOWN.\n"
